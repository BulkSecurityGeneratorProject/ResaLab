...
import fr.sies.resalab.config.audit.AuditEventConverter;
import fr.sies.resalab.domain.PersistentAuditEvent;
...
import static fr.sies.resalab.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
