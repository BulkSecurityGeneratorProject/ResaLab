...
import fr.sies.resalab.domain.Agent;
import fr.sies.resalab.repository.AgentRepository;
...
public class AgentResourceIntTest {
    ...
    public void createAgent() throws Exception {
        ...
        assertThat(testAgent.getDepartment()).isEqualTo(DEFAULT_DEPARTMENT);
    }
    ...
    public void updateAgent() throws Exception {
        ...
        assertThat(testAgent.getDepartment()).isEqualTo(UPDATED_DEPARTMENT);
    }
