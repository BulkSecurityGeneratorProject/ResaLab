...
public class SalleResourceIntTest {
    ...
    private static final Long DEFAULT_MAX_CAPACITE = 1L;
    private static final Long UPDATED_MAX_CAPACITE = 2L;
    ...
    public static Salle createEntity(EntityManager em) {
        Salle salle = new Salle()
            ...
            .maxCapacite(DEFAULT_MAX_CAPACITE)
    ...
    public void createSalle() throws Exception {
        ...
        assertThat(testSalle.getNumero()).isEqualTo(DEFAULT_NUMERO);
        assertThat(testSalle.getMaxCapacite()).isEqualTo(DEFAULT_MAX_CAPACITE);
    ...
    public void getAllSalles() throws Exception {
        ...
        restSalleMockMvc.perform(get("/api/salles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].maxCapacite").value(hasItem(DEFAULT_MAX_CAPACITE.intValue())))
    ...
    public void getSalle() throws Exception {
        ...
        restSalleMockMvc.perform(get("/api/salles/{id}", salle.getId()))
            ...
            .andExpect(jsonPath("$.maxCapacite").value(DEFAULT_MAX_CAPACITE.intValue()))
    ...
    public void updateSalle() throws Exception {
        ...
        updatedSalle
            ...
            .maxCapacite(UPDATED_MAX_CAPACITE)
        ...
        assertThat(testSalle.getNumero()).isEqualTo(UPDATED_NUMERO);
        assertThat(testSalle.getMaxCapacite()).isEqualTo(UPDATED_MAX_CAPACITE);
